...
class item_similarity_recommender_py():
    ...
    #Get all the unique items (songs) in the training data inside a list
    ...
    def construct_cooccurence_matrix(self, user_songs, all_songs):
        #all_songs=list of all unique songs in dataset
        #user_songs=list of all songs user has previuosly listened     
        ####################################
        ...
        #len(user_songs) X len(all_songs in dataset)
        ###############################################
